...
public:
    ...
    void cabDetails()
    {
        ...
        cout << "-----------Uber Cabs-----------\n" << endl;
        cout << "1. Rent a Standard Cab - TK.15 for 1KM" << endl;
        cout << "2. Rent a Luxury Cab - TK.25 per 1KM" << endl;
        ...
        if(cabChoice == 1){
            ...
            cout << "\nYour tour will cost " << cabCost << " Taka for a standard cab" << endl;
            ...
            cout << "\nYour tour will cost " << cabCost << " Taka for a luxury cab" << endl;
            cout << "Press 1 to hire this cab: or ";
            cout << "Press 2 to select another cab: ";
            cin >> hireCab;
            system("CLS");
...
public:
    ...
    void hotels()
    {
        string hotelNo[] = {"Marvel", "ChoiceYou", "ElephantBay"};
        for(int a = 0; a < 3; a++)
        {
        ...
        if(choiceHotel == 1){
            cout << "-------WELCOME TO HOTEL Marvel-------\n" << endl;

            cout << "The Garden, food and beverage. Enjoy all you can drink, Stay cool and get chilled in the summer sun." << endl;

            cout << "Packages offered by Marvel:\n" << endl;

            cout << "1. Standard Pack" << endl;
            cout << "\tAll basic facilities you need just for: Tk.5000.00" << endl;
            cout << "2. Premium Pack" << endl;
            cout << "\tEnjoy Premium: Tk.10000.00" << endl;
            cout << "3. Luxury Pack" << endl;
            cout << "\tLive a Luxury at Marvel: Tk.15000.00" << endl;
            ...
            if (packChoice1 == 1){
                hotelCost = 5000.00;
                cout << "\nYou have successfully booked Standard Pack at Marvel" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 2){
                hotelCost = 10000.00;
                cout << "\nYou have successfully booked Premium Pack at Marvel" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 3){
                hotelCost = 15000.00;
                cout << "\nYou have successfully booked Luxury Pack at Marvel" << endl;
                cout << "Goto Menu to take the receipt" << endl;
            }
            else{
                cout << "Invalid Input! Redirecting to Previous Menu \nPlease Wait!" << endl;
            ...
            cout << "\t Tk.15000.00 for a day" << endl;
            cout << "2. Couple Pack" << endl;
            cout << "\t Tk.10000.00 for a day" << endl;
            cout << "3. Single Pack" << endl;
            cout << "\t Tk.5000.00 for a day" << endl;
            ...
            cout << "Amazing offer in this summer: Tk.5000.00 for a one day!!!" << endl;
...
public:
    ...
    void printBill()
    {
        ...
        {
            outf << "--------Tanvir Travel Agency--------" << endl;
            outf << "-------------Receipt-------------" << endl;
